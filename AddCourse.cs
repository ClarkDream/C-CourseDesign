...
namespace Project
{
    public partial class AddCourse : Form
    {
        ...
        public AddCourse()//初始化组件
        {
            InitializeComponent();
        }

        private void label6_Click(object sender, EventArgs e)//退出按钮配置
        {
            Application.Exit();
        }

        private void button_login_Click(object sender, EventArgs e)//登录按钮配置
        {
            ...
            else
            {
                ...
                {
                    MessageBox.Show("Course feild for this semester is already filled.");
                }
